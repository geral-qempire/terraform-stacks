...
module "region_abbreviations" {
  source = "git::https://github.com/geral-qempire/terraform-modules.git?ref=modules/az_region_abbreviations_v2/v1.0.1"
}
...
module "action_group" {
  ...
  source = "git::https://github.com/geral-qempire/terraform-modules.git?ref=modules/az_action_group_map/v1.0.1"
...
module "storage_account" {
  source = "git::https://github.com/geral-qempire/terraform-modules.git?ref=modules/az_storage_account_v2/v1.1.1"
  ...
  network_rules_ip_rules            = length(var.allowed_public_ip_addresses) > 0 ? var.allowed_public_ip_addresses : local.selected_parameter_tier.allowed_public_ip_addresses
  ...
  enable_geo_priority_replication   = local.selected_parameter_tier.enable_geo_priority_replication
